...
/**
 * A settlement in the activity list. Deliberately not interactive: editing a
 * payment is a later phase, and a card that looks clickable but is not is worse
 * than one that does not.
 */
export default function PaymentCard({ payment, userMap }: PaymentCardProps) {
  return (
    <div className="w-full bg-white rounded-3xl shadow-sm p-5 flex items-center justify-between gap-3 border border-zinc-100">
